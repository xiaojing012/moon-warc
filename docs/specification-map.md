...
| 5.14, WARC-Target-URI | Required on response/resource/request/revisit/conversion/continuation; forbidden on warcinfo | *planned* (`record.mbt`, `validator.mbt`) | *planned* |
